...
CREATE TABLE IF NOT EXISTS `add_value` (
...
INSERT INTO `add_value` (`value_id`, `qus_id`, `user_id`, `value_points`, `status`, `notes`, `value_date`) VALUES
(16, 22, 7, 'good answer.', 1, 'test.', '2014-08-10 06:45:08');
...
INSERT INTO `article_tag` (`tag_id`, `tag_name`) VALUES
(21, 'Income Tax'),
(27, 'php'),
(31, 'java'),
(32, 'bass biz'),
...
INSERT INTO `article_tag_map` (`id`, `tag_id`, `post_id`) VALUES
(2, 21, 42),
(3, 31, 42),
(14, 32, 56),
(34, 27, 48),
...
INSERT INTO `feedback_contact` (`id`, `who`, `what`, `name`, `designation`, `company`, `email`, `mobile`, `feedback`, `file`, `date`) VALUES
(37, 'Business Partner', 'Complaint', 'Sathish', 'CEO', 'Bass', 'mail@mail.com', 9994788678, 'good.', 'feedback_files/2054772636.', '2014-08-09 13:11:49'),
(38, 'Business Partner', 'Complaint', 'Sathish', 'CEO', 'JJ corp', 'mail@mail.com', 9994788938, 'good.', 'feedback_files/493151398.', '2014-08-09 16:51:21'),
(39, 'Business Partner', 'Complaint', 'Kumar', 'CEO', 'Techs', 'mail@mail.com', 9994567834, 'good.', 'feedback_files/1419170147.', '2014-08-09 16:56:24'),
(40, 'Business Partner', 'Complaint', 'Sathish', 'CEO', 'Techs', 'mail@mail.com', 9994578390, 'good.', 'feedback_files/731721253.', '2014-08-09 17:12:51'),
(41, 'Business Partner', 'Complaint', 'Kumar', 'CEO', 'Bass Techs', 'mail@mail.com', 9994567823, 'godd.', 'feedback_files/596107398.', '2014-08-09 17:25:10'),
(42, 'Business Partner', 'Complaint', 'Test', 'CEO', 'test', 'mail@mail.com', 9983938930, 'test', 'feedback_files/1900028557.', '2014-08-09 17:27:49');
...
INSERT INTO `google_login` (`id`, `name`, `email`, `mobile`, `inserted_on`) VALUES
(7, 'Sathish', 'sjksathishkumar@gmail.com', 9997866789, '2014-07-09 09:45:30'),
(8, 'basstechs', 'basstechsindia@gmail.com', 9994788682, '2014-07-12 15:26:46'),
(9, 'Balaji M', 'balajikarthiq@gmail.com', 9994788645, '2014-07-12 22:23:25'),
(15, 'Rinsy Ullas', 'rinsy.ullas@gmail.com', 5685336664, '2014-07-21 18:31:27'),
(19, 'karthiq m', 'karthiq.m@gmail.com', NULL, '2014-07-23 08:09:52'),
(24, 'Bass Biz', 'bassbizindia@gmail.com', NULL, '2014-07-23 11:52:30'),
(25, 'VGrow Monger', 'vgrowmonger@gmail.com', NULL, '2014-07-23 11:58:37'),
(26, 'Antony B Adaikalam', 'aantonycma@gmail.com', 9884040580, '2014-07-23 12:03:25');
...
INSERT INTO `jobs` (`candidate_id`, `job_id`, `name`, `qualification`, `Experience`, `mobile`, `email`, `resume`, `date`) VALUES
(17, '1', 'Sathish', 'b.Tech', 'Fresher', 9994788682, 'sjksathishkumar@gmail.com', 'resume/390961300.', '2014-08-09 16:22:27');
...
(5, 'kumar', 'kumar@gmail.com', 'e3b9a522ac3a5bf8fbb9fdc788d0cf1a8c24b1e78ab6eb0f216efac40cd0d03c2925e52769b76edbffc9fc323cb75d298835951da4abd31b97deeb919d548d8e', '8228a9f09aeb06fbac673a163ac65fbdb62daad60a86c3729ba2ff7386d17181620866a9106b1afc708650b9c684d4be57f4bd1f262abacb35847f3e3205ee5a');
...
INSERT INTO `partner_contact` (`id`, `name`, `designation`, `company`, `investment`, `mobile`, `email`, `city`, `state`, `country`, `postal_code`, `reason`, `time`) VALUES
(21, 'Sathish', 'Head', 'Team-s', 'Upto 5 Laks', 9989389098, 'kumar@gmail.com', 'Chennai', 'TN', 'IN', 898789, 'For fun.', '2014-07-11 15:04:33'),
(23, 'Rinsy Ullas', 'fghdsaa', 'xyz', 'Upto 5 Laks', 9876543212, 'rinsy.ulls@gmail.com', 'chennai', 'tamilnadu', 'india', 234565, 'eryuiioooookh', '2014-07-22 14:53:26');
...
INSERT INTO `questions` (`qus_id`, `question`, `description`, `user_id`, `answer`, `ans_rply`, `qus_date`) VALUES
(20, 'Test question.', 'Need description.', 8, 'Answer will given you shortly.', 1, '2014-07-14 12:42:36'),
(21, 'Updated question by Sathish. ', 'description change.', 26, '<p>Content would be updated by sathish.</p>\r\n', 1, '2014-07-23 12:07:16'),
(22, 'Test question by vimal.', 'Description.', 7, '<p>Answer will be give soon.</p>\r\n', 1, '2014-08-10 06:41:12');
...
INSERT INTO `questions_tag` (`tag_id`, `tag_name`) VALUES
(11, 'income tax'),
(12, 'sales tax'),
(13, 'income tax'),
(14, 'CA2013'),
...
CREATE TABLE IF NOT EXISTS `questions_tag_map` (
  `id` int(4) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `questions_tag_map` (`id`, `tag_id`, `qus_id`) VALUES
(3, 13, 20),
(4, 14, 21),
(5, 15, 21),
(6, 11, 22),
...
INSERT INTO `sales_contact` (`id`, `name`, `designation`, `company_name`, `company_type`, `mobile`, `email`, `city`, `state`, `country`, `postal_code`, `requirements`, `description`, `date`) VALUES
(37, 'Sathishkumar', 'Developer', 'Bass Techs', 'Partnership', 9994788678, 'kumar@gmail.com ', 'Chennai ', 'Tamilnadu', 'India', 600106, '', ' Need to deal with your company.', '2014-07-11 12:43:17'),
(39, 'Sathish', 'Developer', 'Bass Techs', 'Partnership', 8973878987, 'bass@mail.com ', 'Trichy ', 'TN', 'IN', 789076, 'business_registration,', ' TEst', '2014-07-11 13:04:18'),
(40, 'Sathishkumar', 'Developer', 'Bass Techs', 'Partnership', 8938495890, 'sjksathishkumar@gmail.com ', 'Chennai ', 'TN', 'IN', 787809, '', ' Need Details.', '2014-07-11 14:08:35'),
(43, 'aji', 'xxxx', 'www', 'Properatorship', 9876543212, 'rinsy.ulls@gmail.com ', 'chennai ', 'tamilnadu', 'india', 234565, 'business_registration,', 'rtuvfj ', '2014-07-22 14:52:00');
...
--
-- Constraints for table `add_value`
--
ALTER TABLE `add_value`
  ADD CONSTRAINT `add_value_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `google_login` (`id`),
  ADD CONSTRAINT `add_value_ibfk_2` FOREIGN KEY (`qus_id`) REFERENCES `questions` (`qus_id`);

--
-- Constraints for table `article_tag_map`
--
ALTER TABLE `article_tag_map`
  ADD CONSTRAINT `article_tag_map_ibfk_1` FOREIGN KEY (`tag_id`) REFERENCES `article_tag` (`tag_id`),
  ADD CONSTRAINT `article_tag_map_ibfk_2` FOREIGN KEY (`post_id`) REFERENCES `article` (`post_id`);

--
-- Constraints for table `questions`
--
ALTER TABLE `questions`
  ADD CONSTRAINT `questions_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `google_login` (`id`);

--
-- Constraints for table `questions_tag_map`
--
ALTER TABLE `questions_tag_map`
  ADD CONSTRAINT `fk_qus_id` FOREIGN KEY (`qus_id`) REFERENCES `questions` (`qus_id`),
  ADD CONSTRAINT `fk_tag_id` FOREIGN KEY (`tag_id`) REFERENCES `questions_tag` (`tag_id`);
