...
<html lang="en">
  ...
  <body>
   ...
   <div class="container">
    <div class="row">
        <div class="text-center feature-head">
          ...
          <div class="content">
                        ...
                        <form method="post" action="signup.php?package=sliver&&noofemp=5" ">
                         <div class="form-group">
                            <label for="companyname">Company Name</label>
                            <input type="text" name="companyname" class="form-control">
                        </div>
                        <div class="form-group">
                          <label for="street">Address<br>Street Name</label>
                        ...
                        <div class="form-group">
                         ...
                         <label for="pemail">pemail</label>
                            <input type="text"  name="pemail" class="form-control" >
                              ...
                              <div class="form-group">
                         <label for="pmobile">pmobile</label>
                            <input type="text"  name="pmobile" class="form-control" >
                        </div>
                        <br>
                           <button class="btn btn-danger service-btn" type="submit">Submit</button>
                   </form>
                   </div>
                   </div>
            </div>
    ...
    $("#state").autocomplete({source:state});
    </script>
