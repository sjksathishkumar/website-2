        ...
        <div class="row">
            ...
            <div class="col-lg-9 ">
                <?php
                  ...
                  $query = "Select * FROM article ORDER BY post_date DESC LIMIT $start_from, $num_rec_per_page";
                ...
                <div class="text-center">
                    ...
                    <?php 
                        ...
                        echo "<li><a href='page-1'>".'«'."</a></li>"; // Goto 1st page  

                        for ($i=1; $i<=$total_pages; $i++) { 
                                    echo "<li><a href='page-".$i."'>".$i."</a></li>"; 
                        }
                        echo "<li><a href='page-$total_pages'>".'»'."</a></li>"; // Goto last page
                    ?>              
