...
<html lang="en">
  ...
  <section id="container" class="">
          ...
          <section class="wrapper">
              ...
              <section class="panel">
                  <header class="panel-heading">
                      <div align="center"><strong>Feedbacks</strong></div>
                  </header>
                  <div class="panel-body">
                        <div class="adv-table">
                            <table cellpadding="0" cellspacing="0" border="0" class="display table table-bordered" id="feedback_table">
                                <thead>
                                <tr>
                                    <th>ID</th>
                                    <th>Who</th>
    ...
    <script src="js/feedback_view.js" > </script>
