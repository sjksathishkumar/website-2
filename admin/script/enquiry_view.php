...
$aColumns = array('uid', 'name', 'company_name', 'status', 'work_status', 'mobile', 'designation', 'amount', 'industry', 'description', 'package','enquiry_date', 'email', 'no_emp');
...
$query = " select distinct * from enquiry order by enquiry_date desc;";
