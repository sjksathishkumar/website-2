...
$aColumns = array('id', 'name', 'company_name', 'mobile', 'email', 'date', 'designation', 'company_type','city','state','country','postal_code','requirements','description');
...
$query = " select distinct * from sales_contact order by date desc;";
