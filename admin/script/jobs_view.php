...
$aColumns = array('candidate_id', 'job_id', 'name', 'qualification', 'experience','date', 'mobile', 'email', 'resume');


/* Indexed column (used for fast and accurate table cardinality) */
$sIndexColumn = "candidate_id";
...
$query = " select distinct * from jobs order by date desc;";
