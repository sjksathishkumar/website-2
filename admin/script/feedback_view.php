...
$aColumns = array('id', 'who', 'what', 'name', 'company','date', 'designation', 'email', 'mobile', 'feedback','file');
...
$query = " select distinct * from feedback_contact order by date desc;";
