...
$aColumns = array('id', 'name', 'company', 'mobile', 'email', 'time', 'designation', 'investment','city','state','country','postal_code','reason');
...
$query = " select distinct * from partner_contact order by time desc;";
