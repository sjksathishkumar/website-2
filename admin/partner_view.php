...
<html lang="en">
  ...
  <section id="container" class="">
          ...
          <section class="wrapper">
              ...
              <section class="panel">
                  <header class="panel-heading">
                      <div align="center"><strong>Partner Enquiry</strong></div>
                  </header>
                  <div class="panel-body">
                        <div class="adv-table">
                            <table cellpadding="0" cellspacing="0" border="0" class="display table table-bordered" id="partner_table">
                                <thead>
                                <tr>
                                    <th>ID</th>
                                    <th>Name</th>
    ...
    <script src="js/partner_view.js" > </script>
