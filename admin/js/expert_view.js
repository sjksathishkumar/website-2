var EditableTable = function () {
    ...
    return {
		  ...
		  function fnFormatDetails ( oTable, nTr )
      {
          ...
          sOut += '<tr valign="top"><td width="10%"><b>Status: </b>'+aData[6]+'</td><td width="30%"><b>Description: </b>'+aData[3]+'</td><td width="20%"><b>Email: </b>'+aData[11]+'</td></tr>';
          sOut += '<tr valign="top"><td width="10%"></td><td width="30%"><b>Answer: </b>'+aData[4]+'</td><td width="20%"><b>Tags: </b>'+aData[9]+'</td></tr>';
