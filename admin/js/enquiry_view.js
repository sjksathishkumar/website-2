var EditableTable = function () {
    ...
    return {
      ...
      var nCloneTh = document.createElement( 'th' );
        ...
        "bProcessing": true,
    "bServerSide": true,
    "sAjaxSource": "script/enquiry_view.php",
    "sServerMethod": "POST",
      ...
      "aiExclude": [ 0 ]
          ...
          function fnFormatDetails ( oTable, nTr )
          {
              ...
              sOut += '<tr valign="top"><td width="5%"></td><td width="95%"><b>Description : </b>'+aData[10]+'</td></tr>';
              sOut += '<tr valign="top"><td width="5%"></td><td width="95%"><b>Package : </b>'+aData[11]+'</td></tr>';
              sOut += '<tr valign="top"><td width="5%"></td><td width="95%"><b>Date : </b>'+aData[12]+'</td></tr>';
              sOut += '<tr valign="top"><td width="5%"></td><td width="95%"><b>Email : </b>'+aData[13]+'</td></tr>';
              sOut += '<tr valign="top"><td width="5%"></td><td width="95%"><b>Designation : </b>'+aData[7]+'</td></tr>';
              sOut += '<tr valign="top"><td width="5%"></td><td width="95%"><b>Industry : </b>'+aData[9]+'</td></tr>';
              sOut += '<tr valign="top"><td width="5%"></td><td width="95%"><b>No of Emp : </b>'+aData[14]+'</td></tr>';
              sOut += '<tr valign="top"><td width="5%"></td><td width="95%"><b>Amount : </b>'+aData[8]+'</td></tr>';
