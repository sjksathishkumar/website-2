var EditableTable = function () {
    ...
    return {
        ...
        init: function () {
            ...
            function saveRow(oTable, nRow) {
                ...
                $.ajax( {
                    dataType: 'html',
                    type: "POST",
                    url: "script/designation-update.php",
                    cache: false,
                    data: mydata,
		...
		"aLengthMenu": [
				...
				"bProcessing": true,
		"bServerSide": true,
		"sAjaxSource": "script/designation-view.php",
		"sServerMethod": "POST",
		 ...
		 e.preventDefault();
			...
			$.ajax( {
                    dataType: 'html',
                    type: "POST",
                    url: "script/designation-add.php",
                    cache: false,
                    data: adddata,
					success: function(data) {
						if(data == "success")
            ...
            $('#editable-sample a.delete').live('click', function (e) {
				...
				$.ajax( {
                        dataType: 'html',
                        type: "POST",
                        url: "script/designation-del.php",
                        cache: false,
                        data: mydata,
                        success: function(data) {
						if(data == "success")
