...
<html lang="en">
  <head>
    ...
    <title>Enquiry - Admin | Bass Desio</title>
  ...
  <section id="container" class="">
          ...
          <section class="wrapper">
              ...
              <section class="panel">
                  <header class="panel-heading">
                      <div align="center"><strong>Enquiry</strong></div>
                  </header>
                  ...
                  <div class="modal-dialog">
                    <div class="modal-content">
                     ...
                     <div class="modal-body">
                      <section class="panel">
                          <form role="form" id="enquiry_detail" method="post" action="script/enquiry_update.php" enctype="multipart/form-data">
                                  <div>
    ...
    <script src="js/enquiry_view.js" > </script>
