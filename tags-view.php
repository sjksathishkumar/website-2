        ...
        <div class="row">
            ...
            <!--blog start-->
                   <div class="col-lg-9 ">
                    ...
                    <div class="row">
                        <div class="col-lg-2 col-sm-2 text-right">
                          ...
                          <div class="col-lg-10 col-sm-10">
                          <header>
                     <h1>             <a href="blog_detail.php?post_id=<?php echo $post['post_id']; ?>"><?php echo $post['post_title']; ?></a>
                ...
                ?></p>
                    ...
                    <a href="blog_detail.php?post_id=<?php echo $post['post_id']; ?>"  class="btn btn-danger">Continue Reading</a>
                      </div>
              ...
              <?php
                ...
                <div class="blog-side-item">
                  ...
                  <li>
                    <p><a href="tag_view.php?tag_id=<?php echo $post['tag_id']; ?>"><?php echo $post['tag_name']; ?></a> <a href="tag_view.php?tag_id=<?php echo $post['tag_id']; ?>">
                     </i></a>
