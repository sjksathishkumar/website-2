  ...
  if( isset( $_POST ) && $_SERVER['REQUEST_METHOD'] == "POST" )
   {
	 ...
	 */
	$obj              = new AjaxRequest();
	$response         = $obj->search( $_POST['_userId'], ' && P.status = "1" && P.id '.$query.' '.$offset, 'LIMIT '.$postnumbers, $_SESSION['authenticated'] );
			   				...
			   				<p>
			   					...
			   					<?php if( $key['video_site'] != '' ) : 
									...
									echo $key['video_title'].' '. _Function::linkText( $key['video_url'] );
			   						...
			   						<a class="linkImage" href="<?php echo URL_BASE.'upload/'.$key['photo']; ?>" rel="lightbox">
