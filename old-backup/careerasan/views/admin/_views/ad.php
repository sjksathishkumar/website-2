<div class="content">
	<div class="grid_left">
		...
		<form action="" method="post" enctype="multipart/form-data" id="upload">
			...
			<label>Code<br /> HTML/Adsense:</label>
			<textarea  id="ad" name="ad"><?php echo $this->settings->ad; ?></textarea>
			
			<input type="submit" name="submit" value="Save" id="button_update" class="bt_update button_ad" />
