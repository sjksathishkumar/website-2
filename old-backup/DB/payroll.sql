...
--
-- Host: localhost
-- Generation Time: May 10, 2013 at 02:55 PM
...
(21, 'BTIP589', 30, 30, 0, 'March', '2013', 0),
...
(41, 'BTIP001', 30, 28, 2, 'March', '2013', 0);
...
(1, 'BTIP001', 'BTIP', 'DESG02', 'DPT05', '1987-05-27', '2013-02-04', '044-2245854', '9786903717', 'gunadat@gmail.com', 'photos/btip001-gunasegar mani.jpg', 'ST01', 'Chennai-5'),
(2, 'BTIP1111', 'BTIP', 'DESG03', 'DPT01', '1987-03-10', '2012-03-01', '', '', '', 'photos/btip002-priyanka.jpg', 'ST01', 'Madurai-66'),
(5, 'BTIP7852', 'BTIP', 'DESG03', 'DPT01', '1987-11-12', '2012-01-01', '', '', '', 'photos/btip7852-rajasekar.jpg', 'ST01', ''),
(195, 'BTIP129', 'BTIP', '', '', '0000-00-00', '0000-00-00', '', '', '', '', '', ''),
...
(205, 'BTIP961', 'BTIP', '', '', '0000-00-00', '0000-00-00', '', '', '', '', '', ''),
...
INSERT INTO `emp_esislab` (`id`, `company_code`, `field`, `value`, `cal_from`) VALUES
(1, 'BTIP', 'ESI Employee Contribution', '12%', 'gross_pay'),
(2, 'BTIP', 'ESI Employer Contribution', '12%', 'gross_pay'),
(3, 'BTIP', 'ESI Eligibility', '15000', 'gross_pay');
...
INSERT INTO `emp_leave` (`id`, `emp_id`, `company_code`, `leave_code`, `day`, `month`, `year`, `pay_status`) VALUES
(1, 'BTIP001', 'BTIP', 'SL', 12, 'March', 2013, '0'),
(2, 'BTIP001', 'BTIP', 'CL', 29, 'March', 2013, '0'),
(3, 'BTIP002', 'BTIP', 'SL', 12, 'February', 2013, '0');
...
INSERT INTO `emp_pay_slab1` (`id`, `fields`, `value`, `cal_from`, `key_word`) VALUES
(1, 'House Rent Allowance (HRA)', '22%', 'gross_pay', 'hra'),
(2, 'Conveyance Allowance (CA)', '4%', 'gross_pay', 'ca'),
(3, 'Special Allowance (SA)', '35%', 'gross_pay', 'sa'),
(4, 'Education Allowance (EA)', '4%', 'gross_pay', 'ea'),
(5, 'Medical Allowance (MA)', '4%', 'gross_pay', 'ma'),
(6, 'LTA', '6%', 'gross_pay', 'lta'),
(7, 'Provident Fund (PF) from Employer', '12%', 'basic_pay', 'pf1'),
(8, 'Provident Fund (PF) from Employee', '12%', 'basic_pay', 'pf2'),
(9, 'ESI from Employer', '1.75%', 'gross_pay', 'esi1'),
(10, 'ESI from Employee', '4.75%', 'gross_pay', 'esi2');
...
INSERT INTO `emp_pay_slab2` (`id`, `fields`, `value`, `cal_from`, `key_word`) VALUES
(1, 'House Rent Allowance (HRA)', '22%', 'gross_pay', 'hra'),
(2, 'Conveyance Allowance (CA)', '4%', 'gross_pay', 'ca'),
(3, 'Special Allowance (SA)', '35%', 'gross_pay', 'sa'),
(4, 'Education Allowance (EA)', '4%', 'gross_pay', 'ea'),
...
(9, 'ESI from Employer', '1.75%', 'gross_pay', 'esi1'),
(10, 'ESI from Employee', '4.75%', 'gross_pay', 'esi2'),
(11, 'Basic Pay', '40%', 'gross_pay', 'basic');

-- --------------------------------------------------------

--
-- Table structure for table `emp_pay_slab3`
--

CREATE TABLE IF NOT EXISTS `emp_pay_slab3` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `fields` varchar(50) NOT NULL,
  `value` varchar(50) NOT NULL,
  `cal_from` varchar(50) NOT NULL,
...
--
-- Dumping data for table `emp_pay_slab3`
--

INSERT INTO `emp_pay_slab3` (`id`, `fields`, `value`, `cal_from`, `key_word`) VALUES
(1, 'House Rent Allowance (HRA)', '22%', 'gross_pay', 'hra'),
(2, 'Conveyance Allowance (CA)', '4%', 'gross_pay', 'ca'),
(3, 'Special Allowance (SA)', '35%', 'gross_pay', 'sa'),
(4, 'Education Allowance (EA)', '4%', 'gross_pay', 'ea'),
...
--
-- Table structure for table `emp_pay_slab4`
--

CREATE TABLE IF NOT EXISTS `emp_pay_slab4` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `fields` varchar(50) NOT NULL,
  `value` varchar(50) NOT NULL,
  `cal_from` varchar(50) NOT NULL,
...
--
-- Dumping data for table `emp_pay_slab4`
--

INSERT INTO `emp_pay_slab4` (`id`, `fields`, `value`, `cal_from`, `key_word`) VALUES
(1, 'House Rent Allowance (HRA)', '22%', 'gross_pay', 'hra'),
(2, 'Conveyance Allowance (CA)', '12%', 'gross_pay', 'ca'),
(3, 'Special Allowance (SA)', '12%', 'gross_pay', 'sa'),
(4, 'Education Allowance (EA)', '12%', 'gross_pay', 'ea'),
(5, 'Medical Allowance (MA)', '2%', 'gross_pay', 'ma'),
(6, 'LTA', '40%', 'gross_pay', 'lta'),
(7, 'Provident Fund (PF) from Employer', '12%', 'basic_pay', 'pf1'),
(8, 'Provident Fund (PF) from Employee', '12%', 'basic_pay', 'pf2'),
(9, 'ESI from Employer', '10%', 'gross_pay', 'esi1'),
(10, 'ESI from Employee', '4.75%', 'gross_pay', 'esi2');
...
INSERT INTO `emp_pay_structure` (`id`, `pay_name`, `pay_type`, `table_name`, `amount`) VALUES
(2, 'slab1', 'Basic', 'emp_pay_slab1', 6500),
(3, 'slab2', 'gross_pay', 'emp_pay_slab2', 18000),
(4, 'slab3', 'CTC', 'emp_pay_slab3', 100000),
(14, 'slab4', 'Basic', 'emp_pay_slab4', 6250);
...
INSERT INTO `emp_pay_temp` (`id`, `emp_id`, `pay_slab`, `pay_type`) VALUES
(1, 'BTIP001', 'slab1', 'Basic'),
(2, 'BTIP002', 'slab4', 'Basic'),
(3, 'BTIP7852', 'slab3', 'CTC'),
(42, 'BTIP129', 'slab3', 'CTC'),
(43, 'BTIP303', 'slab1', 'Basic'),
(44, 'BTIP703', 'slab2', 'gross_pay'),
(45, 'BTIP509', 'slab2', 'gross_pay'),
(46, 'BTIP325', 'slab2', 'gross_pay'),
(47, 'BTIP694', 'slab4', 'Basic'),
(48, 'BTIP323', 'slab1', 'Basic'),
(49, 'BTIP521', 'slab1', 'Basic'),
(50, 'BTIP749', 'slab1', 'Basic'),
(51, 'BTIP369', 'slab2', 'gross_pay'),
(52, 'BTIP563', 'slab2', 'gross_pay'),
(53, 'BTIP961', 'slab2', 'gross_pay'),
(54, 'BTIP232', 'slab2', 'gross_pay'),
(55, 'BTIP745', 'slab2', 'gross_pay'),
(56, 'BTIP383', 'slab2', 'gross_pay'),
(57, 'BTIP478', 'slab2', 'gross_pay'),
(58, 'BTIP989', 'slab1', 'Basic'),
(59, 'BTIP830', 'slab2', 'gross_pay'),
(60, 'BTIP747', 'slab4', 'Basic'),
(61, 'BTIP365', 'slab1', 'Basic'),
(62, 'BTIP632', 'slab1', 'Basic'),
(63, 'BTIP589', 'slab1', 'Basic'),
(64, 'BTIP032', 'slab1', 'Basic'),
(65, 'BTIP345', 'slab1', 'Basic'),
(66, 'BTIP496', 'slab1', 'Basic'),
(67, 'BTIP418', 'slab1', 'Basic'),
(68, 'BTIP298', 'slab2', 'gross_pay'),
(69, 'BTIP743', 'slab2', 'gross_pay'),
(70, 'BTIP870', 'slab2', 'gross_pay'),
(71, 'BTIP503', 'slab2', 'gross_pay'),
(72, 'BTIP905', 'slab4', 'Basic'),
(73, 'BTIP698', 'slab1', 'Basic'),
(74, 'BTIP638', 'slab1', 'Basic'),
(75, 'BTIP309', 'slab1', 'Basic'),
(76, 'BTIP432', 'slab1', 'Basic'),
(77, 'BTIP361', 'slab2', 'gross_pay'),
(78, 'BTIP143', 'slab2', 'gross_pay'),
(79, 'BTIP1111', 'slab1', 'Basic');
...
INSERT INTO `emp_pfslab` (`id`, `company_code`, `field`, `value`, `cal_from`) VALUES
(1, 'BTIP', 'PF Employee Contribution', '12%', 'basic_pay'),
(2, 'BTIP', 'PF Employer Contribution', '12%', 'basic_pay'),
(3, 'BTIP', 'Admin Charges', '0.5%', 'total_epf_wages'),
(4, 'BTIP', 'Account 21', '0.5%', 'total_epf_wages'),
(5, 'BTIP', 'Account 22', '0.01%', 'total_epf_wages');
...
INSERT INTO `esi_master` (`id`, `field`, `cal_from`) VALUES
(1, 'ESI Employee Contribution', 'gross_pay'),
(2, 'ESI Employer Contribution', 'gross_pay'),
(3, 'ESI Eligibility', 'gross_pay');
...
INSERT INTO `pf_master` (`id`, `field`, `cal_from`) VALUES
(1, 'PF Employee Contribution', 'basic_pay'),
(2, 'PF Employer Contribution', 'basic_pay'),
(3, 'Admin Charges', 'total_epf_wages'),
(4, 'Account 21', 'total_epf_wages'),
(6, 'Account 22', 'total_epf_wages');
