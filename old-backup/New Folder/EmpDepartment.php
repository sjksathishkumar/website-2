...
<div class="mainwrapper">
    ...
    <div class="rightpanel">
        ...
        <div class="breadcrumbwidget">
        	...
        	<ul class="breadcrumb">
                <li class="active"><a href="CompanyAdmin.php">Dashboard</a> / Departments</li>
            </ul>
        </div><!--breadcrumbs-->
      	<div class="pagetitle">
        	<h1>Departments</h1> <span></span>
        </div><!--pagetitle-->
        ...
        <div class="maincontent">
        	<div class="contentinner content-dashboard">
			  ...
			  <div class="row-fluid">
                 ...
                 <div class="span12">
                    <h4 class="widgettitle nomargin">Configure departments</h4>
                        <div class="widgetcontent bordered">
                         ...
                         <a id="mail" class="btn btn-success" style="float:right; margin:10px; margin-right:0px;"><i class="icon-pencil icon-white"></i>&nbsp;&nbsp;ADD NEW</a>
                            	 <div id="disform">
                        <form action="AddDepartment.php" class="editprofileform" method="post">
     						<input type="hidden" id="master" name="master" value="1" />
                            <label class="clsLabel2">Department Name:</label>
                            ...
                            <!--&nbsp;&nbsp;<input type="button" name="cancel"  class="btn btn-success" value="CANCEL"/>-->
						</form>
                        </div>
                        <!--<a href="AddDepartment.php" class="btn btn-success" style="float:right; margin:10px; margin-right:0px;"><i class="icon-pencil icon-white"></i>&nbsp;&nbsp;ADD NEW</a>-->
       ...
       <table class="table table-bordered" id="dyntable">
        ...
        <?php
		$i=1;
		$resEmp1 = GetDetailsFromQuery("select * from company_dept order by id asc");
        ...
        <?php
                ...
                echo '<td>
				<span style="" id="one_'.$data['id'].'" class="text">'.$data['dept_name'].'</span>
					<input style="width:200px; display:none;" type="text" value="'.$data['dept_name'].'"  id="one_input_'.$data['id'].'" />
...
$(document).ready(function(){
	...
	$(".btn-success").colorbox({inline:false, title:"Add New Department", height:"300px" });
