...
<div class="mainwrapper">
    ...
    <div class="rightpanel">
        ...
        <div class="breadcrumbwidget">
        	...
        	<ul class="breadcrumb">
                <li class="active">Dashboard / Upload Employee attendance Details</li>
            </ul>
        </div><!--breadcrumbs-->
      	<div class="pagetitle">
        	<h1>Dashboard / Upload Employee attendance Details</h1> <span></span>
        </div><!--pagetitle-->
        
        <div class="maincontent">
        	<div class="contentinner content-dashboard">
  
			<h4 class="widgettitle nomargin">Upload Employee attendance Details</h4>
            <div class="widgetcontent bordered">
                <div class="row-fluid">
                    ...
                    <a href="downloadatt.php" class="btn btn-success" style="float:right;" id="downTemp">Download Templete</a>
...
<form enctype="multipart/form-data" action="uploadattend.php" method="post">
  ...
  <p>
    File:
    <input name="uploaded" type="file" maxlength="20" /><input class="btn btn-primary" type="submit" name="upfile" value="Upload File">
  </p>
</form>
