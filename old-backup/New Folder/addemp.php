			...
			function percentage($int1,$int2)
			{
				...
				return $res;
					...
					while($row = mysql_fetch_assoc($salres))
					{
						...
						$iii = mysql_query("insert into test1(emp_id, val1, val2, val3, val4, val5, val6, val7, val8) values ('$emp_id', '$one', '$two','$three','$four','$five','$six','$seven','$eight')");
					}
				...
				else
				{
					...
					$val7 = $_POST['field38'];
					$val8 = $_POST['field39'];
				$iii = mysql_query("insert into test1(emp_id, val1, val2, val3, val4, val5, val6, val7, val8) values ('$emp_id', '$val1', '$val2','$val3','$val4','$val5','$val6','$val7','$val8')");
				}
