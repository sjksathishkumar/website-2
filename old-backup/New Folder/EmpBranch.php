...
<div class="mainwrapper">
    ...
    <div class="rightpanel">
        ...
        <div class="breadcrumbwidget">
        	...
        	<ul class="breadcrumb">
                <li class="active"><a href="CompanyAdmin.php">Dashboard</a> / Branches</li>
            </ul>
        </div><!--breadcrumbs-->
      	<div class="pagetitle">
        	<h1>Branches</h1> <span></span>
        </div><!--pagetitle-->
        ...
        <div class="maincontent">
        	<div class="contentinner content-dashboard">
			  ...
			  <div class="row-fluid">
                 ...
                 <div class="span12">
                    <h4 class="widgettitle nomargin">Configure Branches</h4>
                        <div class="widgetcontent bordered">
                        
                         <table class="table table-bordered">
 <!--<a href="AddBranch.php" class="btn btn-success" style="float:right; margin:10px; margin-right:0px;"><i class="icon-pencil icon-white"></i>&nbsp;&nbsp;ADD NEW</a>-->
                        ...
                        <div id="disform">
                        <form action="AddBranch.php" class="editprofileform" method="post">
     						<input type="hidden" id="master" name="master" value="3" />
        					<label class="clsLabel2" style="width:200px;"><strong>Branch Name</strong></label>
        ...
        <?php
		$i=1;
		$resEmp1 = GetDetailsFromQuery("select * from company_branch order by id asc");
