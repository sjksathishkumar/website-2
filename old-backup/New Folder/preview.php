        	...
        	<div class="contentinner content-dashboard">
                <div class="row-fluid">
                 ...
                 <div class="span12">
                    ...
                    <a class="btn btn-primary" style="float:right; margin-right:10px; margin-bottom:10px;" href="calc.php"><i class="icon-upload icon-white"></i>&nbsp;&nbsp;OK</a>
                    <a class="btn btn-primary" style="float:right; margin-right:10px; margin-bottom:10px;" href="delatt.php"><i class="icon-upload icon-white"></i>&nbsp;&nbsp;Cancel</a>
                    ...
                    <colgroup>
                      ...
                      <thead>
                          <tr>
                              ...
                              <?php 
			$query = "SELECT * FROM emp_attendance WHERE flags=0";
			//print_r($query);
