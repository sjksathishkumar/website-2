  ...
  <!-----------------------------------form start----------------------------------------------------->
   <form action="officialdetails.php" class="editprofileform" method="post" enctype="multipart/form-data">
                   <div class="span6">
                    ...
                    <input type="text" name="emp_id" class="input-large" required/>
                    </p>
                    <p>
                    ...
                    <input type="text" name="dob" class="input-large"  />
                    </p>
                    <p>
                    ...
                    <input type="text"  name="bank_no" id="" class="input-large" />
                    </p>
                    <p>
                    ...
                    <input type="text" name="martial" id="" class="input-large" value="" />
                    </p>
