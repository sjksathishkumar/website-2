                      ...
                      <section class="panel">
                        ...
                        <?php }
                            ...
                            <form action="" method="post">
                                ...
                                <p>
                                	<label style="padding-top:0px; width:200px;">Company Name</label>
                                	: &nbsp;&nbsp;<?php echo GetCompanyName($row['domain_name']);?>
                                </p>
                                <p>
                                	<label style="padding-top:0px; width:200px;">Domain Name</label>
                               ...
                               <!-- <p>
                                ...
                                <p>
                                	<label style="padding-top:0px; width:200px;">Employee Prefix</label>
                                ...
                                <p>
                                    ...
                                    <a href="ManageAdmin.php?id=<?php echo $_GET['id'];?>&k=Edit#PerInfo" >Add Info</a>
                                </p>
                                <?php } ?>
                                <br />
								...
								?>
                                <p>
                                	<label  style="padding-top:0px; width:200px;">Email Id</label>
                                	: &nbsp;&nbsp;<?php echo $row['mail_id'];?>
                                </p>
                                <p>
                                	<label  style="padding-top:0px; width:200px;">Website</label>
                                	: &nbsp;&nbsp;<?php echo $row['web_addr'];?>
                                </p>
                                <p>
                                	<label  style="padding-top:0px; width:200px;">Pan No</label>
                                	: &nbsp;&nbsp;<?php echo $row['pan_no'];?>
                                </p>
                                <p>
                                	<label  style="padding-top:0px; width:200px;">Tan No</label>
                                	: &nbsp;&nbsp;<?php echo $row['tan_no'];?>
                                </p>
                                <p>
                                	<label  style="padding-top:0px; width:200px;">Telephone No.</label>
                                	: &nbsp;&nbsp;<?php echo $row['telephone'];?>
                                </p>
                                <p>
                                	<label  style="padding-top:0px; width:200px;">Mobile No.</label>
                                	: &nbsp;&nbsp;<?php echo $row['mobile_no'];?>
                                </p>
                                <p>
                                	<label  style="padding-top:0px; width:200px;">Fax No.</label>
                                	: &nbsp;&nbsp;<?php echo $row['fax_no'];?>
                                </p>
                                <p>
                                	<label  style="padding-top:0px; width:200px;">Address</label>
                                	: &nbsp;&nbsp;<?php echo $row['addr'];?>
                                </p>
                                 <p>
                                	<label  style="padding-top:0px; width:200px;">Contact Person.</label>
                                	: &nbsp;&nbsp;<?php echo $row['contactperson'];?>
                                </p>
                                <p>
                                	<label  style="padding-top:0px; width:200px;">Contact Mobile</label>
                                ...
                                <?php } ?>
                                <p>
                                	<a href="CompanyProfile.php?id=<?php echo $row['id'];?>&k=Edit">Update Profile</a>
                                </p>
                            </form>
