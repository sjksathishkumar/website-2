                      ...
                      <section class="panel">
                          <header class="panel-heading">
                           ...
                           <?php 
							...
							{
								?>
               <a href="payslip.php" class="btn btn-success" style="float:right; margin:10px; margin-right:0px;"><i class="icon-pencil icon-white"></i>&nbsp;&nbsp;ADD NEW</a>
						<?php	}
							else
							{ ?>
             <a href="editpayslip.php?uniq=1" class="btn btn-success" style="float:right; margin:10px; margin-right:0px;"><i class="icon-pencil icon-white"></i>&nbsp;&nbsp;EDIT</a>
						<?php 	}
