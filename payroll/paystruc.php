               ...
               <form action="Addpayslab.php" class="editprofileform" method="post" >
                        	...
                        	<table width="409" height="289">
                            	...
                            	<tr>
                                    ...
                                    <td width="120">
                                    	 <input type="text" id="field3" name="field3" class="in-sm" value="" required/>
                                ...
                                <tr>
                                    ...
                                    <td>
                                      <input type="text"  name="field5" id="field5" class="input-small Numeric" value="0" onKeyPress="return isNumberKey(event)" />%
 </td>
                                </tr>
                                <tr>
                                	<td>
                                    ...
                                    <td>
                                    	  <input type="text" id="field6" name="field6" class="input-small Numeric" value="0" onKeyPress="return isNumberKey(event)" />%
 </td>
                                </tr>
                                <tr>
                                	<td>
                                    ...
                                    <td>
                                       <input type="text" id="field7" name="field7" class="input-small Numeric" value="0" onKeyPress="return isNumberKey(event)" />%
                                ...
                                <tr>
                                    ...
                                    <td>
                                    	<input type="text" id="field8" name="field8" class="input-small Numeric" value="0" onKeyPress="return isNumberKey(event)"/>%
                                ...
                                <tr>
                                    ...
                                    <td>
                                  		<input type="text" id="field9" name="field9" class="input-small Numeric" value="0" onKeyPress="return isNumberKey(event)"/>% 
                                  ...
                                  <tr>
                                    ...
                                    <td>
                                    	 <input type="text" id="field10" name="field10" class="input-small Numeric" value="0" onKeyPress="return isNumberKey(event)" />%
                                  ...
                                  <tr>
                                    ...
                                    <td>
                                    	  <input type="text" id="field11" name="field11" class="input-small Numeric" value="0" onKeyPress="return isNumberKey(event)" />%
                       		       </td>
                                </tr>
                                  <tr>
                                	<td>
                                    ...
                                    <td>
                              <input type="text" id="field12" name="field12" class="input-small Numeric" value="0" onKeyPress="return isNumberKey(event)"/>%
                                ...
                                <tr>
                                	...
                                	<td>
                                		<input type="submit" id="AddPayStruc" class="btn btn-success" value="ADD NEW" />
                                    </td>
                                </tr>
                             </table>
