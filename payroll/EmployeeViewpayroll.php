              ...
              <!-- page start-->
               ...
               <section class="panel">
                          <div class="panel-body">
                          	 <a class="btn btn-primary" style="float:right; margin-right:10px; margin-bottom:10px;" href="viewpdf.php"><i class="icon-upload icon-white"></i>&nbsp;&nbsp;Payslip Download</a>
           <a class="btn btn-primary" style="float:right; margin-right:10px; margin-bottom:10px;" href="viewmail.php"><i class="icon-upload icon-white"></i>&nbsp;&nbsp;Send Mail</a>
              ...
              <div class="row">
                  <div class="col-lg-12">
                    ...
                    <tbody>
						...
						if($value[0] == January)
						{$retrieve = "SELECT * FROM jan WHERE month='$value[0]' AND year='$year[0]' AND flag=1";}
						else if($value[0] == February){$retrieve = "SELECT * FROM feb WHERE month='$value[0]' AND year='$year[0]' AND flag=1";}
						else if($value[0] == March){$retrieve = "SELECT * FROM march WHERE month='$value[0]' AND year='$year[0]' AND flag=1";}
						else if($value[0] == April){$retrieve = "SELECT * FROM april WHERE month='$value[0]' AND year='$year[0]' AND flag=1";}
						else if($value[0] == May){$retrieve = "SELECT * FROM may WHERE month='$value[0]' AND year='$year[0]' AND flag=1";}
						else if($value[0] == June){$retrieve = "SELECT * FROM june WHERE month='$value[0]' AND year='$year[0]' AND flag=1";}
						else if($value[0] == July){$retrieve = "SELECT * FROM july WHERE month='$value[0]' AND year='$year[0]' AND flag=1";}
						else if($value[0] == August){$retrieve = "SELECT * FROM august WHERE month='$value[0]' AND year='$year[0]' AND flag=1";}
						else if($value[0] == September){$retrieve = "SELECT * FROM september WHERE month='$value[0]' AND year='$year[0]' AND flag=1";}
						else if($value[0] == October){$retrieve = "SELECT * FROM october WHERE month='$value[0]' AND year='$year[0]' AND flag=1";}
						else if($value[0] == November){$retrieve = "SELECT * FROM november WHERE month='$value[0]' AND year='$year[0]' AND flag=1";}
						else if($value[0] == December){$retrieve = "SELECT * FROM december WHERE month='$value[0]' AND year='$year[0]' AND flag=1";}
