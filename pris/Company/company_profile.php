    	...
    	<?php if(count($result)>0){ foreach($result as $data){ ?>
         <div class="span3 profile-left">
            ...
            <div class="profilethumb">
                ...
                <?php if($data['logo'] != ''){ ?>
                <img src="<?php echo $data['logo'];?>" alt="<?php echo getAdminDisplayName(stripslashes($data['primary_admin']));?>" title="<?php echo getAdminDisplayName(stripslashes($data['primary_admin']));?>" class="img-polaroid" />
                <?php }else{ ?>
                <img src="img/profilethumb.png" alt="<?php echo getAdminDisplayName($username);?>" title="<?php echo getAdminDisplayName($username);?>" class="img-polaroid" />
                <?php } ?>
            </div><!--profilethumb-->
        </div><!-- span3 -->
        <?php  } } ?>
         ...
         <div class="span9">
            <form action="" class="editprofileform" method="post">
                ...
                <p>
                    ...
                    <label class="clsLabel2" style="width:160px;"> : <strong><?php echo $data['code'];?></strong></label><br />
                </p>
                <p>
