                 	...
                 	<div class="span6">
                        ...
                        <p>
                          ...
                          <p>
                            ...
                            <input type=text list="field22" name="field22" value="<?php echo $row['job_status'] ?>">
                            <datalist id="field22" name="field22" > 
                            <?php 
								$sql = GetDetailsFromQuery("select * from employee_status order by id desc");
								foreach($sql as $rows)
								{
									echo "<option value=".$rows['status_name'].">".$rows['status_name']."</option>";
								}
							?>
                        ...
                        <p>
                            <label class="clsLabel1" style="width:120px;">Designation : </label>
                             <input type=text list="field23" name="field23" value="<?php echo $row['desig'] ?>">
                         ...
                         <p>
                          <label class="clsLabel1" style="width:120px;">Department : </label>
                             <input type=text list="field24" name="field24"  value="<?php echo $row['dpt_name'] ?>">
                        ...
                        <p>
                          <label class="clsLabel1" style="width:120px;">Branch Location : </label>
                           <input type=text list="field25" name="field25" value="<?php echo $row['branch_loc'] ?>">
                        ...
                        <p>
                            ...
                            <p>
                                ...
                                <input type="text"  name="field30" id="field30" class="input-large" value="<?php echo $sss['val1']+$sss['val2']+$sss['val3']+$sss['val4']+$sss['val5']+$sss['val6']+$sss['val7']+$sss['val8'];?>" required/>
                            </p>
                            <p>
