  ...
  <!-----------------------------------form start----------------------------------------------------->
   <form action="editofficialdetails.php" class="editprofileform" method="post" enctype="multipart/form-data">
                   <div class="span6">
                    ...
                    <input type="text" name="dob" id="datepicker" class="input-large"  value="<?php echo $row['dob'];?>" />
                    </p>
                    <p>
                    ...
                    <input type="text" pattern="\d*"  maxlength="10" name="mob" id="" class="input-large"  value="<?php echo $row['mobile'];?>" required/>
                    </p>
                    <p>
