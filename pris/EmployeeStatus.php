...
<div class="mainwrapper">
    ...
    <div class="rightpanel">
        ...
        <div class="breadcrumbwidget">
        	...
        	<ul class="breadcrumb">
                <li class="active"><a href="CompanyAdmin.php">Dashboard</a> / Employee Status</li>
            </ul>
        </div><!--breadcrumbs-->
      	<div class="pagetitle">
        	<h1>Employee Status</h1> <span></span>
        </div><!--pagetitle-->
        ...
        <div class="maincontent">
        	<div class="contentinner content-dashboard">
			  ...
			  <div class="row-fluid">
                 ...
                 <div class="span12">
                    <h4 class="widgettitle nomargin">Configure Employee Status</h4>
                        <div class="widgetcontent bordered">
                         ...
                         <a id="mail" class="btn btn-success" style="float:right; margin:10px; margin-right:0px;"><i class="icon-pencil icon-white"></i>&nbsp;&nbsp;ADD NEW</a>
                            	 <div id="disform">
                        <form action="AddNEWEmployee.php" class="editprofileform" method="post">
     						<input type="hidden" id="master" name="master" value="4" />
                            <label class="clsLabel2">Employee Status:</label>
       ...
       <table class="table table-bordered" id="dyntable">
        ...
        <?php
                ...
                echo '<td>
				<span style="" id="one_'.$data['id'].'" class="text">'.$data['status_name'].'</span>
