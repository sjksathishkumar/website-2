...
<div class="row-fluid">
    ...
    <div class="span9">
        ...
        <input type="hidden" id="edit_type" value="MasterAdmin" />
        <h4>Login Information</h4>
        <p>
            <label class="clsLabel" style="padding-top:0px; width:200px;">Company Name</label>
            : <input type="text" name="field1" id="txtfield1" class="input-xlarge" value="<?php echo GetCompanyName($row['domain_name']);?>" />
        </p>
        <p>
           ...
           <span class="help-inline" style="color:#F00;">Not Editable !!!</span>
        </p>
        <p>
        ...
        <p>
            ...
            : <input type="text" name="field2" id="txtfield4" readonly class="input-xlarge" value="<?php echo $row['emp_prefix'];?>" />
             <span class="help-inline" style="color:#F00;">Not Editable !!!</span>
        </p>
