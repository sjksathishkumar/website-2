...
<div class="mainwrapper">
    ...
    <div class="rightpanel">
        ...
        <div class="breadcrumbwidget">
        	...
        	<ul class="breadcrumb">
                <li class="active">Dashboard / ESI Report</li>
            </ul>
        </div><!--breadcrumbs-->
      	<div class="pagetitle">
        	<h1>Dashboard / ESI Report</h1> <span></span>
        </div><!--pagetitle-->
        ...
        <div class="maincontent">
        	<div class="contentinner content-dashboard">
                <div class="row-fluid">
                 ...
                 <div class="span12">
                    <h4 class="widgettitle nomargin">ESI Report</h4>
                        
                     <div class="widgetcontent bordered" id="ListAttandance">
                    <table class="table table-bordered">
<a class="btn btn-primary" style="float:right; margin-right:10px; margin-bottom:10px;" href="downesi.php"><i class="icon-upload icon-white"></i>&nbsp;&nbsp;Download Report</a>
			...
			$val = mysql_query("SELECT * FROM $table WHERE month='$month[0]' AND year='$valyear[0]'");
			//print_r($query);
