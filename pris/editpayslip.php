        ...
        <div class="widgetcontent bordered">
            <div class="row-fluid">
                ...
                error_reporting();
					...
					$uniq = $_GET['uniq'];
					$edit = mysql_query("SELECT * FROM emp_payslip WHERE uniq=1");
					while($row = mysql_fetch_assoc($edit))
					{
				?>
                	<form action="old.php" method="post">
                    	<p align="left">
                        	<input type="text" name="header" value="<?php echo $row['header'];?>" placeholder="Enter Payslip Header" required/> 
                            <input type="hidden" name="uniq" value="1">
                        	&nbsp;&nbsp;Ex:Name of the company
                        </p>
                    	<p>
                    	  <select name="test1">
                          	<option value="<?php echo $row['one'];?>"><?php echo $row['one'];?></option>
                    	...
                    	<p>
                    	  <select name="test2">
                    	    <option value="<?php echo $row['two'];?>"><?php echo $row['two'];?></option>
                    	...
                    	<p>
                    	  <select name="test3">
                    	    <option value="<?php echo $row['three'];?>"><?php echo $row['three'];?></option>
                    	    <option value="House Rent Allowance">House Rent Allowance</option>
                            <option value="City Compensation Allowance">City Compensation Allowance</option>
                            <option value="Foreign Allowance">Foreign Allowance</option>
                            <option value="Fixed Medical Allowance">Fixed Medical Allowance</option>
                    	...
                    	<p>
                    	  <select name="test4">
                    	    <option value="<?php echo $row['four'];?>"><?php echo $row['four'];?></option>
                    	    <option value="House Rent Allowance">House Rent Allowance</option>
                            <option value="City Compensation Allowance">City Compensation Allowance</option>
                            <option value="Foreign Allowance">Foreign Allowance</option>
                            <option value="Fixed Medical Allowance">Fixed Medical Allowance</option>
                    	...
                    	<p>
                    	  <select name="test5">
                    	    <option value="<?php echo $row['five'];?>"><?php echo $row['five'];?></option>
                    	    <option value="House Rent Allowance">House Rent Allowance</option>
                            <option value="City Compensation Allowance">City Compensation Allowance</option>
                            <option value="Foreign Allowance">Foreign Allowance</option>
                            <option value="Fixed Medical Allowance">Fixed Medical Allowance</option>
                    	...
                    	<p>
                    	  <select name="test6">
                    	    <option value="<?php echo $row['six'];?>"><?php echo $row['six'];?></option>
                    	    <option value="House Rent Allowance">House Rent Allowance</option>
                            <option value="City Compensation Allowance">City Compensation Allowance</option>
                            <option value="Foreign Allowance">Foreign Allowance</option>
                            <option value="Fixed Medical Allowance">Fixed Medical Allowance</option>
                    	...
                    	<p>
                          	  <select name="other1">
                    	    <option value="<?php echo $row['seven'];?>"><?php echo $row['seven'];?></option>
                    	    <option value="House Rent Allowance">House Rent Allowance</option>
                            <option value="City Compensation Allowance">City Compensation Allowance</option>
                            <option value="Foreign Allowance">Foreign Allowance</option>
                            <option value="Fixed Medical Allowance">Fixed Medical Allowance</option>
                    	...
                    	<p>
                          	  <select name="other2">
                    	    <option value="<?php echo $row['eight'];?>"><?php echo $row['eight'];?></option>
                    	    <option value="House Rent Allowance">House Rent Allowance</option>
                            <option value="City Compensation Allowance">City Compensation Allowance</option>
                            <option value="Foreign Allowance">Foreign Allowance</option>
                            <option value="Fixed Medical Allowance">Fixed Medical Allowance</option>
