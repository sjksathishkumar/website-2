...
$query ="INSERT INTO `feedback` (`name`, `email`, `phone`, `companyname`, `address1`, `address2`, `pincode`, `message`,`file`) VALUES ( '$name', '$email', '$phone', '$companyname', '$address1', '$address2 ', '$pincode ', '$message','$target' );";
