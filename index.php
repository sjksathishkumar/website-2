...
<html lang="en">
  <head>
    ...
    <meta name="description" content="Bass PRIS offers fully automated and customized cloud based payroll and recruitment solution and payroll and recruitement outsourcing support"/>
             ...
             <ul id="revolutionul" style="display:none;">
                ...
                <!--     <div class="caption lfl slide_item_right"
                     ...
                     <div class="caption lfr slide_title slide_item_left yellow-txt"
                          ...
                          data-start="3500"
                          data-easing="easeOutExpo">
                        We're hear to assist at anytime
                     ...
                     <div class="caption lfr slide_desc slide_item_left"
                          ...
                          data-start="4500"
                          data-easing="easeOutExpo">
                           Bass Pris payroll team will work as like
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="text-center feature-head">
                <h1>welcome to BassPris</h1>
                <p>Smart move to minimize your cost and time</p>
            </div>
            <div class="col-lg-4 col-sm-4">
                <section>
                    <div class="f-box">
                             <i class="fa fa-forward"></i>
                        <h2>Simple & Fastest</h2>
                    </div>
                    <p class="f-text">BASS PRIS, a online payroll information
                         system with comprehensive features and
                         simplified solution to prepare pay slips.</p>
                </section>
            </div>
            <div class="col-lg-4 col-sm-4">
                <section>
                    <div class="f-box active">
                        ...
                        <h2>Fully Automated Payroll Process</h2>
                    </div>
                    <p class="f-text">BASS PRIS offer fully automated and customized
                            cloud based payroll and recruitment solution..</p>
                </section>
            </div>
            <div class="col-lg-4 col-sm-4">
                <section>
                    <div class="f-box">
                        ...
                        <h2>Secured Data & 100% Uptime</h2>
                    </div>
                    <p class="f-text"> BASS PRIS payroll team will work as like insource team,Bass Pris will provide a full
                           pledged support to all the payroll compliance.</p>
                </section>
            </div>
            <!--feature end-->
        </div>
            ...
            <div class="quote">
                <div class="col-lg-9 col-sm-9">
                    <div class="quote-info">
                        <h1>cloud Based payroll solution and affordable</h1>
