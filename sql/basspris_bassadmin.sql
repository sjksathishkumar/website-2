...
INSERT INTO `article_tag` (`tag_id`, `tag_name`) VALUES (21,'Income-Tax'),(27,'php'),(31,'java'),(32,'Bass-Biz'),(33,'Service-Tax'),(34,'companies-act-2013'),(36,'bass-biz'),(37,'tax-planning'),(40,'Tax');
...
INSERT INTO `article_tag_map` (`id`, `tag_id`, `post_id`) VALUES (14,32,56),(34,27,48),(40,37,84),(42,27,51),(43,21,48),(44,21,51),(45,21,56),(46,21,83),(47,21,84),(72,27,42);
...
INSERT INTO `client` (`id`, `companyname`, `address`, `email`, `mobile`, `pname`, `pemail`, `pmobile`, `noofemp`, `package`) VALUES (1,'','','',0,'','',0,5,'sliver');
...
INSERT INTO `contact` (`id`, `name`, `company_name`, `email`, `mobile`, `address`, `message`, `date`, `status`) VALUES (3,'sathish','bass','sathish@gmail.com',9999839388,'chennai','message','2014-11-07 11:57:24','New'),(5,'','','',0,'','','2014-11-25 13:02:47','New'),(6,'','','',0,'','','2014-11-25 19:25:25','New');
...
CREATE TABLE `enquiry` (
  ...
  `work_status` varchar(50) NOT NULL DEFAULT 'New',
  PRIMARY KEY (`uid`),
...
INSERT INTO `enquiry` (`uid`, `name`, `company_name`, `designation`, `mobile`, `industry`, `description`, `package`, `no_emp`, `amount`, `enquiry_date`, `email`, `activation`, `status`, `work_status`) VALUES (10,'Girish','Bass Biz Services Pvt Ltd','Director','8682050777','Accounting-Payroll','I required for payroll services for 250 employee provide good comptive  quotation','platinum',500,17049,'2014-10-20','girish@bassbiz.in','0fa0915bb0511fd5a577f147c465c4d9','verified','Closed');
...
INSERT INTO `login_attempts` (`user_id`, `time`) VALUES (5,'1405184580'),(5,'1405495622'),(5,'1405587551'),(5,'1406013147'),(5,'1406097497'),(5,'1406097512'),(5,'1406191041'),(5,'1406265608'),(5,'1415683952'),(5,'1415685141');
...
INSERT INTO `members` (`id`, `username`, `email`, `password`, `salt`) VALUES (5,'Admin','basstechsindia@gmail.com','39dcfb786d50749ed6aeadab0113f7e64d9326a065becece5d4a74377a55dc61e6c4c3df301214f0671b28ddb4ae2b21f2277f6420ad2295f5663399b8161fe4','4365d9fc2dd487beee5e3f3d1d7cab3263fc63f79e80d0f7c0b2b1837fa772fad73015dc68539a23de8ad1d3bd410a674fc54b2f399e84e95c29db0b4015f7a4');
...
INSERT INTO `users` (`uid`, `email`, `password`, `activation`, `status`) VALUES (10,'sjksathishkumar@gmail.com','078dc595e3663750846941f646f06a2d','8a310aa9193946590cf036418e47bc71','1');
